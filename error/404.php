  ...
  <style>
        *{
        ...
        .formulaire_container {
            ...
            -webkit-box-shadow: 0.05rem 0.05rem 0.7rem 0px #00000048;
                    box-shadow: 0.05rem 0.05rem 0.7rem 0px #00000048;
            padding: 1.5rem;
            display: -webkit-box;
            display: -ms-flexbox;
            display: flex;
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                            <div class="formulaire_flex">
                                <div class="for_title">4<span class="crimson">0</span>4<span class="for_small">CETTE PAGE N'EXISTE PAS</span></div>
                            </div>
                    </div>
                </div>
        </div>
