...
if (isset($_SESSION["idAdmin"])) {
    ...
    $usersRequest = $dbRequest->query("SELECT * FROM `products` WHERE categorie_id=1");
...
<a href="connexion.php">
    ...
    <h4 class="mt-4 title" align="center">Laptop</h4>
       ...
       <table class="table">
        ...
        <?php  foreach ($usersInfo as $key => $value) : ?>
             <tr>
                 ...
                 <td  style="word-wrap: break-word;word-break: break-all;"><a href="editer/laptop_editer.php?id=<?= $value->id ?>"><button class="btn btn-dark">EDITER</button></a><a href="delete.php?id=<?= $value->id ?>"><button class="btn btn-danger">DELETE</button></a></td>
             </tr>
        <?php endforeach ?>
        </tbody>
    </table>
