...
if (isset($_SESSION["idAdmin"])) {
    ...
    if (!isset($_GET["id"]) || $_GET["id"] == "") {
        header("location:../../connexion/connexion-admin.php");
          ...
          $countProductDesc = $dbRequest->query("SELECT * FROM `description_outil` WHERE id_product=$id");
                 ...
                 <div class="col-md-6">
                    <div class="card-custom form-container shadow-sm w-100">
                             <form method="post" id="form-smart">
                                   <input type="text" name="lib_product" placeholder="Nom complet du produit" class="form-control form-custom" value="<?= $productInfo[0]->lib_product?>">
                                   <input type="number" name="price_product" class="form-control mt-2 form-custom" placeholder="Prix du produit" value="<?= $productInfo[0]->price?>">
                                   <input type="hidden" name="choice_outil" value="update">
               ...
               <div class="col-md-12">
                   ...
                   <div class="card-custom  form-container shadow-sm w-100 mt-4 p-4">
                         <div class="row">
                               ...
                               <div class="col-md-12">
                                        <textarea name="other_desc_product_sm" id="" cols="30" rows="4" class="form-control form-custom" placeholder="DESCRIPTION" form="form-smart" value="<?= $productInfoDesc[0]->descriptions?>"></textarea>
                                       
                               </div>
                               <div class="p-2 mt-2">
                                      <button type="submit" class="w-100 btn btn-primary btn_submit_outil" form="form-smart" id="button-smart">Update product</button>
                               </div>
