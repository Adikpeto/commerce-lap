...
<head>
  ...
  <title>Commerce-Lap: Faqs; Les reponses à vos question.</title>
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                            <div class="page_big_title">FAQS </div>

                            <!-- Comment trouver un produit sur Commerce-Lap ?  -->
                            <h1 class="faqs_title">Comment trouver un produit sur Commerce-Lap ?</h1>
                            ...
                            <!-- Comment regarder les caracteristiques d'un produit ? -->
                            <h1 class="faqs_title">Comment regarder les caracteristiques d'un produit ?</h1>
                            <p class="pt-2">
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi   de ma capacité à comprendre les défis des autres domaines à savoir le graphisme et le SEO. 
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond.
                            </p>
                            <img src="../public/assets/FAQS/description-des-produits.png" class="img-fluid mt-4"/>
                             ...
                             <h1 class="faqs_title mg-large">Comment ajouter un produit à sont panier ?</h1>
                            <p class="pt-2">
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi   de ma capacité à comprendre les défis des autres domaines à savoir le graphisme et le SEO. 
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond.
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi   
                             ...
                             <!-- Comment commander vos produit ?-->

                             <h1 class="faqs_title mg-large">Comment commander vos produit ?</h1>
                            <p class="pt-2">
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi   de ma capacité à comprendre les défis des autres domaines à savoir le graphisme et le SEO. 
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond.
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi 
                            ...
                            <img src="../public/assets/FAQS/commander.png" class="img-fluid mt-4"/>
                             ...
                             <h1 class="faqs_title mg-large">Comment payer votre commande ?</h1>
                            <p class="pt-2">
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi   de ma capacité à comprendre les défis des autres domaines à savoir le graphisme et le SEO. 
                             ...
                             <h1 class="faqs_title mg-large">Comment nous contacter ?</h1>
                            <p class="pt-2">
                                Développeur web chevronné dans plusieurs langages de développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond-end et back-end, mais aussi   de ma capacité à comprendre les défis des autres domaines à savoir le graphisme et le SEO. 
                                développement web. Je souhaite évoluer dans votre entreprise et travailler sur vos projets dans le domaine du développement web car c’est ce qui me passionne. J’aimerais contribuer à la réalisation de vos sites, pages et applications à l’aide de ma connaissance du développement frond. 
                            </p>
                            <img src="../public/assets/FAQS/comment-nous-contacter.png" class="img-fluid mt-4"/>
